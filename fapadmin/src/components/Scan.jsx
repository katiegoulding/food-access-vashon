  ...
  handleScan = data => {
    if (data) {
      ...
      if (this.props.role === "farmer") {
        ...
        // also add the voucher id to the user's list of associated ids and mark that the voucher
        // has been redeemed but not yet paid out
        ...
        // also add the voucher id to the user's list of associated ids, is this necessary?
        // do we want to put something else in here?
        userRef.child("vouchersList").update({
          [data]: "true"
        });
      } else {
